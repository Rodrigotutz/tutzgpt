...
export const SidebarChatButton = ({chatItem, active, onClick, onDelete, onEdit}: Props) => {
    ...
    return (
        <div onClick={handleClickButton} className={`flex items-center rounded-md p-3
        text-sm cursor-pointer hover:bg-gray-500/10 ${active ? 'bg-gray-500/20' : 'bg-transparent'}`}>
            <div className="mr-3">
            ...
            <div className="flex-1 text-sm overflow-y-hidden">
                {editing &&
                    <input className="w-full bg-transparent text-sm outline-none border
                    border-blue-500/80" value={titleInput} 
